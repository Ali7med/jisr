...
///
/// ⚠️ **آخر ما بقي من التكامل المباشر في الهاتف.** التطبيق لم يعد يستعمله
/// ([ADR-0009]: السيرفر يتولّى كل اتصال بالشركات، والنسخة العاملة صارت في
/// `apps/server/src/integrations/tuya/signer.ts`). يبقى هنا لسبب واحد:
/// `tool/tuya_probe.dart` أداة التحقّق في **T-V**. يُحذف مع الأداة فور
/// إقفال معيار قبول T-V.
///
