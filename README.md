...
| | |
|---|---|
| تطبيق الهاتف — **عميل رفيع** يتصل بالسيرفر وحده | ✅ أجهزة · مشاهد · إشعارات · أتمتة (قراءة) — `analyze` نظيف · ٣٩ اختباراً |
| **التحقق مقابل Tuya حقيقي** | 🔴 **الخطوة التالية** — [T-V](docs/03-roadmap.md) · تحتاج مفاتيحك وجهازك |
| السيرفر | 🟢 مصادقة · حسابات · أجهزة · أوامر · سجلّ · قناة لحظية · **أتمتة ومشاهد وإشعارات** · **عائلة وأذون** — ١٤٨ اختباراً |
| النشر | 🟡 التركيبة جاهزة ([دليل التشغيل](docs/runbook.md)) · الهجرات مُختبَرة على Postgres 17 محلياً · لم تُنشر على خادم بعد |
| لوحة الويب | 🟢 دخول · حسابات · أجهزة · سجلّ · **بانِي أتمتة بصري عربي** · مشاهد · إشعارات |
